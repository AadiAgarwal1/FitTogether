...
public class DietTrackerPage {
    ...
    public Scene getScene() {
        ...
        // Main title for the page (FitTogether)
        Label fitTogetherTitle = new Label("FitTogether");
        fitTogetherTitle.setStyle("-fx-text-fill: #3ea808; -fx-font-size: 32px; -fx-font-weight: bold; text-align: center;"); // Apply custom style

        // Diet Tracker as a headline
        Label pageTitle = new Label("Diet Tracker");
        pageTitle.setStyle("-fx-text-fill: #FF5722; -fx-font-size: 24px; -fx-font-weight: bold; text-align: center;"); // Apply custom style
        ...
        buttonLayout.getStyleClass().add("button-container"); // Apply button container style
        ...
        // Add the main title (FitTogether), Diet Tracker title, and buttons
        layout.getChildren().addAll(fitTogetherTitle, pageTitle, buttonLayout);
