...
public class EditDietEntriesPage {
    ...
    private void setupUI() {
        ...
        titleLabel.getStyleClass().add("title"); // Add custom CSS class for styling

        // ComboBox for selecting diet entry
        ...
        // Create buttons with updated size and styling
        ...
        Button dietTrackerButton = new Button("Back");
        styleButton(dietTrackerButton);
    ...
    private void styleButton(Button button) {
        ...
        button.setMinWidth(150); // Increase minimum width
        button.setMinHeight(40); // Increase minimum height
