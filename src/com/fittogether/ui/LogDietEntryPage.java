...
public class LogDietEntryPage {
    ...
    private void setupUI() {
        ...
        scene.getStylesheets().add(getClass().getResource("/resources/dietlog.css").toExternalForm()); // Load CSS
    }
    ...
    private TextField createTextField(String promptText) {
        ...
        textField.setStyle("-fx-font-size: 16px;"); // Increase font size for input boxes
        return textField;
    }
