...
public class WorkoutPage {
    ...
    public Scene getScene() {
        ...
        // Title for the FitTogether page (main title)
        Label fitTogetherTitle = new Label("FitTogether");
        fitTogetherTitle.setStyle("-fx-font-size: 36px; -fx-font-weight: bold; -fx-text-fill: #3ea808; -fx-padding: 10px 0; -fx-alignment: center;"); // FitTogether title styling

        // Title for the page (Workout Tracker)
        Label pageTitle = new Label("Workout Tracker");
        pageTitle.setStyle("-fx-text-fill: #FF5722; -fx-font-size: 24px; -fx-font-weight: bold;"); // Styling for the page title
        ...
        // Add the titles and button layout to the main layout
